...
class OAuthProviderException extends ApiException
{
    ...
    /**
     * @param string $reason
     * @param \XeroAccountingAPILib\Http\HttpRequest $request
     * @param \XeroAccountingAPILib\Http\HttpResponse $response
     * @param string $error
     */
    public function __construct(
        string $reason,
        \XeroAccountingAPILib\Http\HttpRequest $request,
        \XeroAccountingAPILib\Http\HttpResponse $response,
        string $error
    ) {
     ...
     * @required
     * @maps error
     * @factory \XeroAccountingAPILib\Models\OAuthProviderErrorEnum::checkValue
     */
