...
|  --- | --- | --- | --- | --- | --- |
| `overpayments` | [`?(Overpayment[])`](../../doc/models/overpayment.md) | Optional | - | getOverpayments(): ?array | setOverpayments(?array overpayments): void |

## Example

```php
use XeroAccountingAPILib\Models\Builders\OverpaymentsBuilder;
...
$overpayments = OverpaymentsBuilder::init()
    ->overpayments(
        [
