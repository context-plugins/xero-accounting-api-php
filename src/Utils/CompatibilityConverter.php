...
namespace XeroAccountingAPILib\Utils;
...
use XeroAccountingAPILib\Http\HttpContext;
use XeroAccountingAPILib\Http\HttpRequest;
use XeroAccountingAPILib\Http\HttpResponse;
