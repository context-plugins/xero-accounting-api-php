...
class XeroAccountingAPIClientBuilder
{
    /**
     * @var array
     */
    ...
    /**
     * @see XeroAccountingAPIClientBuilder::authorizationCodeAuthCredentials
     *
    ...
    public function build(): XeroAccountingAPIClient
    {
        return new XeroAccountingAPIClient($this->config);
    }
}
