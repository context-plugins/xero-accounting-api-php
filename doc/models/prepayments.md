...
|  --- | --- | --- | --- | --- | --- |
| `prepayments` | [`?(Prepayment[])`](../../doc/models/prepayment.md) | Optional | - | getPrepayments(): ?array | setPrepayments(?array prepayments): void |

## Example

```php
use XeroAccountingAPILib\Models\Builders\PrepaymentsBuilder;
...
$prepayments = PrepaymentsBuilder::init()
    ->prepayments(
        [
