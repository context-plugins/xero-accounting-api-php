...
| `CENTRALSTANDARDTIME` |
| `ENUM_CENTRALSTANDARDTIMEMEXICO` |
| `CANADACENTRALSTANDARDTIME` |
| `USMOUNTAINSTANDARDTIME` |
| `ENUM_MOUNTAINSTANDARDTIMEMEXICO` |
| `MOUNTAINSTANDARDTIME` |
| `ENUM_PACIFICSTANDARDTIMEMEXICO` |
| `PACIFICSTANDARDTIME` |
| `ALASKANSTANDARDTIME` |
...
```php
use XeroAccountingAPILib\Models\TimeZoneEnum;

$timeZone = TimeZoneEnum::EAFRICASTANDARDTIME;
```
